    ...
    with sqlite3.connect(log_path) as connection:
        ...
        rows = connection.execute(
            ...
            SELECT tick, peak_population, crowding_multiplier, peak_crowding_multiplier,
                   ...
                   chemical_a_total, chemical_b_total,
