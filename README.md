...
Build upward from the first energy loop into feeding and lifecycle pressure: nutrient sampling, death on depletion, and the first viable seeded organisms.
