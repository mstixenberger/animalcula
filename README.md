...
Build upward from the event-bearing mutation-and-sweep loop into fuller evolution and analytics: richer mutation operators, better motor mappings, reproduction controls, and better headless tooling.
