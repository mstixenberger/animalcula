...
Build upward from the headless nursery/recycling/turbo/genome loop into fuller evolution and analytics: explicit speciation event tracking, richer long-run sweep/interestingness analysis, and a less ad hoc seed library format.
