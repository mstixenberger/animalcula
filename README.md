...
Build upward from the headless nursery/recycling/turbo/genome loop into fuller evolution and analytics: richer motor-topology mutation, stronger lineage/speciation metrics, and a less ad hoc seed library format.
