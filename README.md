...
Build upward from the headless nursery/recycling/turbo/genome loop into fuller evolution and analytics: richer long-run sweep/interestingness analysis, stronger species-lifespan/turnover reporting, and a less ad hoc seed library format.
